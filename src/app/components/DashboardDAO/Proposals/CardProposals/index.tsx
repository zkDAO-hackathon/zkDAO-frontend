	...
	return (
		<div className='card bg-white shadow-md rounded-2xl p-6 hover:shadow-lg transition-shadow duration-300'>
			<div className='flex justify-between items-start mb-3'>
				<h2 className='font-bold text-lg text-gray-800 truncate max-w-[70%]'>{name}</h2>
			...
			<div className='mt-4 flex flex-col space-y-3 text-gray-500'>
				<div className='font-medium flex items-center gap-2'>
					...
					<span>By:</span> <span className='text-gray-700'>{`${by.substring(0, 6)}…${by.substring(by.length - 4)}`}</span>
				</div>
